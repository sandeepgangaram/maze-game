...
document.addEventListener("keydown", (event) => {
  ...
  const speedLimit = 10;
  if ((event.code === "KeyW" || event.code === "ArrowUp") && y > -speedLimit) {
  ...
  if ((event.code === "KeyS" || event.code === "ArrowDown") && y < speedLimit) {
    Body.setVelocity(ball, { x, y: y + 5 });
  }
  if (
